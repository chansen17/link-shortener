        ...
        <div className="w-full py-12 min-h-[50vh] relative overflow-x-hidden">
            <div className="mxw">
                <div className="w-full flex flex-col-reverse md:grid grid-cols-1 md:grid-cols-2 place-items-center gap-y-10 md:gap-y-0 gap-4 md:gap-6">
                    <div>
                        <h2 className='text-5xl md:text-6xl lg:text-7xl font-black text-gray-800'>More than just shorter links</h2>
                        ...
                        <button className='mt-4 py-4 px-5 rounded-full bg-teal-500 hover:bg-teal-500/50 duration-300 text-white font-medium'>Get Started</button>
                    </div>
                    <div>
                        <img src={HeaderAsset} className="ml-24 md:ml-32 lg:ml-52 xl:ml-72 scale-105 h-full w-full" alt="" />
                    </div>
                </div>
            </div>
        </div>
